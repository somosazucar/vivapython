...
BLOG_AUTHOR = "equipo viva python"  # (translatable)
BLOG_TITLE = {"es":"Viva Python"}  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://vivapython.com/"
# This is the URL where nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://todopython.com/"
BLOG_EMAIL = "equipo@somosazucar.org"
BLOG_DESCRIPTION = "Aprenda sobre el lenguaje favorito de programación del mundo."  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        #("/tutorial_index.html", "Tutoriales"),
        #("/juegos_index.html", "Web"),
        #("/movil_index.html", "Móvil"),
        #("/juegos_index.html", "Juegos"),
        #("/programas_index.html", "Programas"),
        ("/categorias/index.html", "Artículos y tutoriales"),
        ("/articulos/instala-python.html", "Instala Python"),
        #("/rss.xml", "feed RSS"),
    ),
}
...
LOGO_URL = '/images/vivapython.png'
...
DEPLOY_COMMANDS = ["rsync -rav -e 'ssh -p 2244' output/ icarito@vivapython.com:/srv/vivapython.com/"]
...
LICENSE = """<br/>
<a rel="license" href="http://creativecommons.org/licenses/by-nc-sa/2.5/co/">
<img alt="Creative Commons Licenses BY-NC-SA"
...
CONTENT_FOOTER = 'Contents &copy; {date}         <a href="mailto:{email}">{author}</a>' \
                + '<br/>Powered by <a href="http://getnikola.com" rel="nofollow">Nikola</a> ' \
                + '{license}'
...
# (translatable)
SOCIAL_BUTTONS_CODE = """
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-540aba6060a5a758"></script>
"""
